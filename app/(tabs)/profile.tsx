      ...
      <SafeAreaView style={styles.safe} edges={["top"]}>
        ...
        <View style={{
          ...
          <View style={{
            flexDirection: "row",
            alignItems: "center",
            backgroundColor: pillExpanded ? c.surface : "transparent",
            borderRadius: 999,
            borderWidth: 1,
            borderColor: pillExpanded ? c.border : "transparent",
            paddingHorizontal: 4,
            paddingVertical: 4,
            shadowColor: "#000000",
            shadowOpacity: pillExpanded ? 0.08 : 0,
            shadowRadius: 10,
            shadowOffset: { width: 0, height: 3 },
            elevation: pillExpanded ? 3 : 0,
          }}>
            ...
            <Animated.View style={{ flexDirection: "row", alignItems: "center", overflow: "hidden", width: pillAnim.interpolate({ inputRange: [0, 1], outputRange: [0, 150] }), opacity: pillAnim }}>
              ...
              <View style={{ width: 1, height: 16, backgroundColor: c.border }} />
              <TouchableOpacity style={{ paddingHorizontal: 10, paddingVertical: 6 }} onPress={togglePill}>
